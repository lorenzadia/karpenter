...
func (p *Provider) createLaunchTemplate(ctx context.Context, options *amifamily.LaunchTemplate, nodeTemplate *v1alpha1.AWSNodeTemplate) (*ec2.LaunchTemplate, error) {
	...
	networkInterface, err := p.generateNetworkInterface(ctx, nodeTemplate)
	if err != nil {
		return nil, err
	}
...
func (p *Provider) generateNetworkInterface(ctx context.Context, nodeTemplate *v1alpha1.AWSNodeTemplate) ([]*ec2.LaunchTemplateInstanceNetworkInterfaceSpecificationRequest, error) {
